...
*/
  override def run(ctx: SourceContext[Tweet]): Unit = {
    ...
    cb.setDebugEnabled(true)
      .setOAuthConsumerKey("sqxDlYUEuI2DmWT1uw6OTkUyp")
      .setOAuthConsumerSecret("1ELYlwe3Ht4X0oXOpMfMCwRPkaz2XGZ65FJolY4Kwh8wR0UhTX")
      .setOAuthAccessToken("888419108143865859-SAlqEuCI2LhMFGeKSeUtYD6CACQW5xE")
      .setOAuthAccessTokenSecret("11Nw0OOk8bpSJSdFiCevZwVdQHIZD2xJWlB9y0JHiT4WR")
